...
const last = (array, callback) => callback(array.slice(-1))
...
function uniq(array) {
 ...
 //result = (arr2) => console.log(`The new names array with all the duplicate items removed is ${arr2}`)
/*
...
// CODE HERE 
//const display = (array, id) => {console.log('The user with the id 16t has the email of ' + array.email + ' the name of ' + array.name + ' and the address of ' + array.address)}

const getUserById = (array, id, callback) => {
  array.filter((id) => callback(id))
